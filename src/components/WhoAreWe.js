  ...
  return (
    <div className="lev2" id="wrv">
      ...
      <p>
        ...
        fastest-time-to-value in any industry. We want our customers to spend
        their valuable time effectively on planning, creating and building large
        enterprises without worrying about infrastructure or people issues.
      </p>
    </div>
  );
}
